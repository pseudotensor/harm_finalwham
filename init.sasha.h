...
#elif( TESTNUMBER == 107 )  // 1D Riemann problem #3 from RAM paper
#define NXTEST 400 
#define NYTEST 1
#define NZTEST 1
#undef REMOVERESTMASSFROMUU
...
struct Ccoordparams {
    double timescalefactor, rho0, u0, Omega0, vz0, tstart, L0;
}  coordparams;

double interpn( int order, double x_eval,  double x1, double f1, double x2, double f2, double x3, double f3, double x4, double f4, double x5, double f5, double x6, double f6 );
int bounds_generate( int i, int j, int k, double *prim );
static int readin_bondi_solution(int *pN_bondi, double *pR0_bondi, double *pRin_bondi, double *pRout_bondi, double *pgam_bondi, double *prho_bondi, double *puu1_bondi, double *pu_bondi );
